...
if __name__ == '__main__':
    ''' (Transfer Learning) Three networks by adding a FC layer'''
    ''' Load dataset '''
    data_dir = 'largeFace'
    splits = ['train', 'test']
    ...
    parser.add_argument('is_train', type = str, help = "\'yes\' for finetuning network. \'no\' for using pretrained")
    ...
    torch.save(model_ft, 'saved_model_' + args.model + '.pth')
